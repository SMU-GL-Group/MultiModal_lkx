...
from data_augmentation.pytorch_grad_cam.utils.find_layers import replace_layer_recursive
from data_augmentation.pytorch_grad_cam.ablation_layer import AblationLayer
...
class AblationCAM(BaseCAM):
    ...
    def save_activation(self, module, input, output) -> None:
        """ Helper functions to save the raw activations from the target layer """

...
from MyModel.USA import CrossMIL_TEMq_OMkv_IMkv_3Loss_240806

parser.add_argument('--Description',
                    default='run_CrossMIL_TEMq_OMkv_IMkv_3Loss。电镜q+光镜kv+荧光kv,wLoss。电镜加权光镜、荧光，模态拼接。batch size=1。')
parser.add_argument('--savename', default='250225_光镜（PASM）+荧光+电镜-301+270例_CrossMIL_TEMq_OMkv_IMkv_3Loss_240806(bs=1,六张电镜)')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = CrossMIL_TEMq_OMkv_IMkv_3Loss_240806.Model(args)

...
parser.add_argument('--Description',
                    default='run_CrossModalAttn_3Loss。电镜分别与光镜、荧光经CrossModalAttn后拼接,wLoss。TEM双向交叉注意力与单向交叉注意力的对比。')
parser.add_argument('--savename', default='09-10_光镜（PASM）+荧光+电镜-301+270例_CrossModalAttn_3Loss_240910(电镜Cross光镜荧光,wLoss)')
...
parser.add_argument('--modal', default='OM+IM+TEM', type=str, help='所用模态：IM+TEM / OM+TEM / OM+IM')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = CrossModalAttn_3Loss_240908.Model(args)

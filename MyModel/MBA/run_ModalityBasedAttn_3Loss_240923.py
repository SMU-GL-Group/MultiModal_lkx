...
from MyModel.MBA import ModalityBasedAttn_3Loss_240920

parser.add_argument('--Description',
                    default='run_ModalityBasedAttn_3Loss。电镜加权光镜、荧光，模态拼接后送通道注意力(ModalityBasedAttn)，各模态视为通道。')
parser.add_argument('--savename', default='09-23_光镜（PASM）+荧光+电镜-301+270例_ModalityBasedAttn_3Loss_240923')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = ModalityBasedAttn_3Loss_240920.Model(args)

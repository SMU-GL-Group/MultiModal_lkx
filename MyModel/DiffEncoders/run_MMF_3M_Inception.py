...
from MyModel.DiffEncoders import MMF_3M_Inception_241112
parser.add_argument('--Description',
                    default='run_MMF_3M_Inception。光镜+荧光+电镜。简单特征融合，电镜固定一张。')
parser.add_argument('--savename', default='250302_MN分期-三模态全-前三期_MMF_3M_Inception_241112(电镜固一,299,cat,2e-4)')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = MMF_3M_Inception_241112.Model(args)

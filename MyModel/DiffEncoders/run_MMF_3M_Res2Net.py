...
from MyModel.DiffEncoders import MMF_3M_Res2Net_250225
parser.add_argument('--Description',
                    default='run_MMF_3M_DenseNet。光镜+荧光+电镜。简单特征融合，电镜固定一张。使用Res2Net-50作为编码器')
parser.add_argument('--savename',
                    default='250303_MN分期-三模态全-前三期_MMF_3M_Res2Net_250225(电镜固一,cat)')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = MMF_3M_Res2Net_250225.Model(args)

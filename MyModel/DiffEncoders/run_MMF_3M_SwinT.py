...
import setproctitle
# 修改进程名称（放在最前面）
setproctitle.setproctitle("lkx_预计用至03/05/16：00.pm")
import os.path
...
from MyModel.DiffEncoders import MMF_3M_SwinT_250305
parser.add_argument('--Description',
                    default='run_MMF_3M_SwinT。光镜+荧光+电镜。简单特征融合，电镜固定一张。使用SwinTransformer-B作为编码器')
parser.add_argument('--savename',
                    default='250305_MN分期-三模态全-前三期_MMF_3M_SwinT_250305(电镜固一,cat)')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = MMF_3M_SwinT_250305.Model(args)

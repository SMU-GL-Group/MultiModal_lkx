...
from MyModel.SelfAttn import MMSelfAttn_3Loss_240913
parser.add_argument('--Description',
                    default='run_MMSelfAttn_3Loss.py。光镜+荧光+电镜。各模态使用自注意力加权,cat,wLoss。与跨尺度注意力对比。')
parser.add_argument('--savename', default='09-14_光镜（PASM）+荧光+电镜-301+270例_MMSelfAttn_3Loss_240913(电镜+光镜+荧光,wLoss)')
parser.add_argument('--batch_size', default=4, type=int)
parser.add_argument('--data_path', default='/public/longkaixing/MMF/datasets/光镜（PASM）+荧光+电镜-301+270例', type=str)
parser.add_argument('--num_epochs', default=40, type=int)
parser.add_argument('--modal', default='OM_+IM+TEM', type=str, help='所用模态：IM+TEM / OM+TEM / OM+IM / OM+IM+TEM')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = MMSelfAttn_3Loss_240913.Model(args)
        ...
        k_weights_lst.append(weights_lst)
    ...
    #np.save('{}/结果acc_loss/{}_{}'.format(os.getcwd(), args.savename, 'k_weights_lst'), k_weights_lst)

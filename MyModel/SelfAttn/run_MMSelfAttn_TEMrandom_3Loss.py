...
from MyModel.SelfAttn import MMSelfAttn_TEMrandom_3Loss_241021
parser.add_argument('--Description',
                    default='run_MMSelfAttn_TEMrandom_3Loss。光镜+荧光+电镜。简单特征融合，电镜固定一张，损失加权，多模态单尺度实验组。无预训练')
parser.add_argument('--savename', default='10-30_光镜（PASM）+荧光+电镜-301+270例_MMSelfAttn_TEMrandom_3Loss_241021(电镜固一,wLoss,无预训练,bs=32)')
...
def main():
    ...
    for i in range(0, args.kfold): # 从第i+1折开始
        ...
        # ======================= 模型设置 ======================= #
        model = MMSelfAttn_TEMrandom_3Loss_241021.Model(args)

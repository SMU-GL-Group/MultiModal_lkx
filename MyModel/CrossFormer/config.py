...
_C.MODEL.RESUME = '/public/longkaixing/CrossFormer-main/crossformer-l.pth'
_C.MODEL.FROM_PRETRAIN = '/public/longkaixing/CrossFormer-main/crossformer-l.pth'
...
def update_config(config, args):
    ...
    config.DATA.IMG_SIZE = args.reshape
    config.DATA.NUM_CLS = args.num_cls
    config.DATA.MODAL = args.modal
...
def get_config(args):
    ...
    config = _C.clone()  # 复制基础的配置文件的参数
    update_config(config, args)  # 用args中的参数更新配置文件中的参数

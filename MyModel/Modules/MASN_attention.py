...
class PAM_Module(Module):
    ...
    def __init__(self, in_dim):
        ...
        self.query_conv = Conv2d(in_channels=in_dim, out_channels=in_dim // 8, kernel_size=1) # 1x1卷积升降维
    ...
    def forward(self, v, k, q):
        ...
        proj_query = self.query_conv(q).view(m_batchsize, -1, width * height).permute(0, 2, 1) # 转置
